...
public abstract class JNachos {
	...
	// Swap space
	public static final String SWAPSAPCE = "./SWAP";
	public static OpenFile swap;
	public static BitMap mSwapFree = new BitMap(Machine.NumVirPages);
	...
	public static void initialize(String args[]) {
		...
		int initSize = 1024*128;
		if(JNachos.mFileSystem.create(SWAPSAPCE, initSize)){
			System.out.println("SWAP space created");
			swap = JNachos.mFileSystem.open(SWAPSAPCE);
		}
		else{
			System.exit(0);
		}
