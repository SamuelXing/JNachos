...
public class NachosProcess implements Runnable {
	...
	/**
	 * queue for receiving buffer from other process
	 */
	private LinkedList<BufferPool.Buffer> bufferQueue;
	
	/**
	 * current processing buffer cahce
	 */
	private LinkedList<BufferPool.Buffer> curBufs;
	
	/**
	 * number of buffers the process has applied
	 */
	private int numOfBuf;
	...
	public NachosProcess(String pProcessName) {
		...
		// set current processing buffer to null
		curBufs = new LinkedList<>();
	...
	/**
	 * Gets the buffer queue
	 * 
	 * @return List of queue
	 */
	public LinkedList<BufferPool.Buffer> getBufQueue() {
		return bufferQueue;
	}
	
	/**
	 * Gets the current processing buffer cache
	 * 
	 * @return return current processing buffer cache
	 */
	public LinkedList<BufferPool.Buffer> getCurBuf() {
		return curBufs;
	}
