...
public class Machine {
	...
	public static final int NumVirPages = 1024;
	// shrink the RAM way down: 8-16 pages
	...
	public static void NextProgram(){
		int PC = Machine.readRegister(Machine.PCReg);
		Machine.writeRegister(Machine.PCReg, PC+4);
	}
